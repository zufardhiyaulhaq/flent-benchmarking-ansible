...
openstack server create --security-group sg-standard --key-name ${KEY} --flavor ${FLAVOR} --image ubuntu-xenial --port internal0-1 vm-snsc-1 --availability-zone nova:zu-ovn-compute2
openstack server create --security-group sg-standard --key-name ${KEY} --flavor ${FLAVOR} --image ubuntu-xenial --port internal0-2 vm-snsc-2 --availability-zone nova:zu-ovn-compute2
...
openstack server create --security-group sg-standard --key-name ${KEY} --flavor ${FLAVOR} --image ubuntu-xenial --port internal0-1 vm-dnsc-1 --availability-zone nova:zu-ovn-compute2
openstack server create --security-group sg-standard --key-name ${KEY} --flavor ${FLAVOR} --image ubuntu-xenial --port internal1-1 vm-dnsc-2 --availability-zone nova:zu-ovn-compute2
